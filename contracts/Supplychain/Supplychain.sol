...
/*
  ...
  */
    ...
    //  }
     ...
     // 6th stage purchase item by wholesaler 
  ...
  //  7th shipping item to wholesaler by distribbutor 
...
// 8th stage  item recieved by wholesaler

    function receivedItemByWholesaler(uint256 _productCode)
        public
        onlyWholesaler // check _msgSender() belongs to DistributorRole
    ...
    //  }
     ...
     // 9th stage  item on sale by wholesaler for retalier 
     function sellItemByWholesaler(uint256 _productCode, uint _price ,uint256 _productQuantity)
     public 
     onlyWholesaler
    _ReceivedByWholesaler(_productCode) 
     _CheckQuantity( _productQuantity, items[_productCode].productQuantity  )
    ...
    // 11th stage  item shipped by wholesaler 
